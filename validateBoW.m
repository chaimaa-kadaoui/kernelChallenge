function [acc, mean_acc] = validateBoW(x_train_total,y_train_total, window_size, stride, kernel, p_norm, nb_kmeans_class, max_kmeans_iter)

    %% Preprocess data with bags of words

    [x_train_total_p, C, visual_words] = processBoVW_train(x_train_total, window_size, stride, p_norm, nb_kmeans_class, max_kmeans_iter);
